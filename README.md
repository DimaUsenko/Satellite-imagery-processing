...
Программа предназначена для обозначения на снимке со спутника города с заданными координатам и расчёта NDVI в его окрестностях
...
-----------
  ...
  - Формула NDVI: NDVI = (Pnir - Pred)/(Pnir + Pred)
